...
from hcp_constant.model_hcp_constant import SpatioTemporalModel
...
if __name__ == '__main__':
    ...
    wandb.init(project='stgcn_hcp_timepoints_sliding', save_code=True, config="/data/users3/bthapaliya/FinalSpatioTemporalMedIA/wandb_configs/dynamic_hcp_best.yaml")
