...
from models.components.readout import DecReadout
from models.components.transformer_encoder import TransPoolingEncoder


class THC(nn.Module):
    def __init__(self, all_confs, node_num=100, pos_embed_dim=1200, lr=1e-4):
